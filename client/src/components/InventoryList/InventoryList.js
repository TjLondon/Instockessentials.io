                                ...
                                <h5 className="inventory__subtitle inventory__subtitle--inventoryitem">INVENTORY ITEM</h5>
                                    ...
                                    <div className="inventory__divitems">
                                        ...
                                        <div className="inventory__p2"> 
                                            <p className="inventory__category">{inventories.category}</p>
                                        </div> 
                                    </div>
                                </div>
                                <div className="inventory__divitems">
                                    ...
                                    <div className={`inventory__p2 inventory__status${stockStatus()}`}> {inventories.status}
                                    </div>
                                    ...
                                    <div className="inventory__p2">
                                        <p className="inventory__quantity">{inventories.quantity}</p>
                                    </div>
                                    ...
                                    <div className="inventory__p2">
                                        <p className="inventory__warehouse">{inventories.warehouseName}</p>
                                    </div>
                                </div>
                            </div>
                            <div className="inventory__subtitle"> 
