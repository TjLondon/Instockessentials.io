      ...
      >
        {({ errors, touched, isValidating }) => (
          <Form className="add-warehouse__form">
            ...
            <Field className="add-warehouse__form--input" name="warehouse_name" validate={validateWarehouse} />
            {errors.warehouse_name && touched.warehouse_name && (
              <div className="add-warehouse__form--error">{errors.warehouse_name}</div>
            )}
            <label className="add-warehouse__form--label" htmlFor="">
              Street Address
            </label>
            <Field className="add-warehouse__form--input" name="street" validate={validateStreet} />
            ...
            <Field className="add-warehouse__form--input" name="city" validate={validateCity} />
            ...
            <Field className="add-warehouse__form--input" name="country" validate={validateCountry} />
            ...
            <Field className="add-warehouse__form--input" name="contact" validate={validateContact} />
           ...
           Position
            ...
            <Field className="add-warehouse__form--input" name="position" validate={validatePosition} />
            {errors.position && touched.position && (
              <div className="add-warehouse__form--error">{errors.position}</div>
            )}
            <label className="add-warehouse__form--label" htmlFor="">
           Phone Number
         </label>
            <Field className="add-warehouse__form--input" name="phone" validate={validatePhone} />
           ...
           Email
            ...
            <Field className="add-warehouse__form--input" name="email" validate={validateEmail} />
